<template>
  <div class="absolute top-[-1px] left-[286px]">
    <section class="relative h-[765px] w-[281px] py-[13px] px-[20px]">
      <div class="character-sheet-section-bg">
        <svg viewBox="0 0 281 765">
          <path
      ...
      <div class="relative">
        <!-- Header -->
        <div class="flex mb-[5px] text-gray-light uppercase text-[10px] font-bold">
          <div class="w-[30px]">
