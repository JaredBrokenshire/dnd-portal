<template>
  <div class="relative mx-auto mt-[5px] w-[241px] h-[34px] text-white">
    ...
    <div class="absolute text-center font-bold text-[14px] left-[3px] top-[8px] w-[35px]">{{ $props.value }}</div>
    <div class="absolute uppercase font-bold text-[10px] left-[51px] top-[11px]">Passive {{ $props.skill }}</div>
  </div>
</template>
