<template>
  <div class="pt-0 w-[105px]">
    <section
      class="h-[95px] w-[90px] mx-auto flex flex-col font-bold justify-center leading-[1] relative text-center uppercase"
    >
      <div class="character-sheet-section-bg">
        <svg viewBox="0 0 79 90">
          <path
      ...
      <h2 class="sr-only">Armour Class</h2>

      <div class="text-gray-light relative text-[10px]">Armour</div>
      <div class="text-white relative font-normal text-[26px]">{{ armourClass }}</div>
      <div class="text-gray-light relative text-[10px]">Class</div>
    </section>
  </div>
</template>
