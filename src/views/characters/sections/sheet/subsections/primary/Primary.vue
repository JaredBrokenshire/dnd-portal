<template>
  <div class="right-0 top-[104px] absolute">
    <div class="relative w-[623px] h-[660px] py-[13px] px-[20px]">
      <div class="character-sheet-section-bg">
        <svg viewBox="0 0 623 660">
          <path
      ...
      <div class="flex flex-col h-full relative z-[4]">
        <menu class="mb-[1rem] flex gap-[1rem] list-none p-0 font-bold text-gray-light">
          <li>
            <button
              :class="`${selectedTab === 'Actions' && 'active'}`"
          ...
          <li>
            <button
              :class="`${selectedTab === 'Inventory' && 'active'}`"
              class="primary-menu-button"
          ...
          <li>
            <button
              :class="`${selectedTab === 'Features & Traits' && 'active'}`"
              class="primary-menu-button"
              @click="selectedTab = 'Features & Traits'"
            >
              Features & Traits
            </button>
          </li>
          ...
          <li>
            <button
              :class="`${selectedTab === 'Background' && 'active'}`"
              class="primary-menu-button"
          ...
          <li>
            <button
              :class="`${selectedTab === 'Notes' && 'active'}`"
              class="primary-menu-button"
          ...
          <li>
            <button
              :class="`${selectedTab === 'Extras' && 'active'}`"
              class="primary-menu-button"
              @click="selectedTab = 'Extras'"
            >
              Extras
            </button>
          </li>
...
<script>
  ...
  export default {
    name: "Primary",
    components: {Extras, Notes, Background, FeaturesAndTraits, Inventory, Spells, Actions},
    props: {
      character: {
        type: Object,
        required: true
