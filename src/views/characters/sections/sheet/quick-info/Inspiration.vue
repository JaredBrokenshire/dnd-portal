<template>
  ...
  >
    ...
    <div>
        ...
        <div class="character-sheet-section-bg">
          <svg viewBox="0 0 72 54">
            ...
            <g
              ...
              stroke-width="1"
            >
              <g transform="translate(-1484.000000, -280.000000)">
                <g transform="translate(1484.000000, 280.000000)">
                  <polygon
                    fill="#10161ADB"
      ...
      <div
        class="mt-[.75rem] w-[4.5rem] text-[.8125rem] font-bold uppercase leading-none text-outline"
      >
        Heroic Inspiration
      </div>
    </div>
    ...
    methods: {
      async toggleInspiration() {
        ...
        try {
          ...
          let errorText = "Could not toggle character inspiration, please refresh and try again";
